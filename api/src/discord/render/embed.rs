...
// use bv_core::{service::notify::UserNotification, types::structs::Profile};
...
// pub fn notification(notification: &UserNotification) -> CreateEmbed {
//     match notification {
//         UserNotification::NoDMPermissionPreamble => todo!(),
//         UserNotification::NewIPConnection {
//             profile,
//             block,
//             first_seen,
//             last_seen,
...
//             state,
//         } => todo!(),
//         UserNotification::IPBlockedByHeuristic { heuristic, ip, attempt_at, blocked_at } => todo!(),
//         UserNotification::OneTimePassphrase(p, s) => otp(p, s),
//     }
// }

// pub fn otp(profile: &Profile, passphrase: &String) -> CreateEmbed {
//     base()
//         .author(CreateEmbedAuthor::new("Bloco Vermelho - Senha de Uso Único"))
//         .title(format!("Senha de uso único - {}", profile.username))
//         .description(format!(
//             "Use as seguinte senha para logar no servidor.
//             ```
//             {}
//             ```
//             -# > :warning: Esta senha deixará de funcionar assim que você utilizar ela",
//             passphrase
//         ))
//         .color(colors::INFO)
// }
...
pub fn new_ip_buttons(addr: &Ipv4Addr, target: Option<String>) -> Vec<CreateButton> {
    vec![
        CreateButton::new(
            Id::encode(&Id {
                action: crate::discord::id::Action::AcceptIp,
        ...
        CreateButton::new(
            Id::encode(&Id {
                action: crate::discord::id::Action::PromptBanIp,
                nonce: addr.to_bits().to_string(),
                target,
            })
            .unwrap(),
