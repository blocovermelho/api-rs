...
// A Connection of a Profile to an external service.
#[derive(sqlx::FromRow, Debug, Serialize)]
pub struct Connection {
    // The profile UUID.
    pub profile: Uuid,
    // The UUID of the game server which issued this connection, if any.
    pub issuer: Option<Uuid>,
    // The type of connection, e.g. "mojang:minecraft_uuid", "bv:bedrock_username", etc.
    pub connection_type: String,
    // The data associated with the connection, e.g. OAuth token, username, etc.
